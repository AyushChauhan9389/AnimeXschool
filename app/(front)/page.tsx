                    ...
                    <div className="flex flex-row justify-center w-[1200px] h-[360px] gap-8">
                        <div className="w-1/2 flex justify-center items-center h-full relative">
                            ...
                            <div
                                ...
                                <Button
                                    className="rounded-none bg-transparent text-black border border-black hover:bg-white hover:border-white transition-colors duration-500">Collection</Button>
                            </div>
